	...
	theme: {
		...
		extend: {
			colors: {
				...
				clinic: {
					'50': 'hsl(var(--clinic-50))',
					'100': 'hsl(var(--clinic-100))',
					'200': 'hsl(var(--clinic-200))',
					'300': 'hsl(var(--clinic-300))',
					'400': 'hsl(var(--clinic-400))',
					'500': 'hsl(var(--clinic-500))',
					'600': 'hsl(var(--clinic-600))',
					'700': 'hsl(var(--clinic-700))',
					'800': 'hsl(var(--clinic-800))',
					'900': 'hsl(var(--clinic-900))',
				},
				sidebar: {
