...
import { 
  Calendar, Clock, CreditCard, FileText, Heart, 
  User, Bell, ChevronRight, CalendarPlus, Plus
} from 'lucide-react';
  ...
  return (
    <PageTransition>
      <div className="space-y-6">
        ...
        {/* Dashboard content - Only displaying overview content */}
          ...
          <Card>
            <CardHeader className="pb-2">
              <div className="flex justify-between items-start">
                ...
                <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-foreground" onClick={() => window.location.href = '/dashboard/appointments'}>
          ...
          {isPregnant ? (
            <Card>
              <CardHeader className="pb-2">
                <div className="flex justify-between items-start">
                  ...
                  <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-foreground" onClick={() => window.location.href = '/dashboard/pregnancy'}>
                    <ChevronRight className="h-4 w-4" />
                  </Button>
                </div>
              </CardHeader>
              <CardContent>
                ...
                <div className="mt-4">
                  <Button variant="outline" size="sm" className="w-full" onClick={() => window.location.href = '/dashboard/pregnancy'}>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <Button variant="outline" size="sm" className="w-full" onClick={() => window.location.href = '/dashboard/records'}>
          ...
          <Card>
            <CardHeader className="pb-2">
              <div className="flex justify-between items-start">
                ...
                <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-foreground" onClick={() => window.location.href = '/dashboard/records'}>
                  <ChevronRight className="h-4 w-4" />
                </Button>
              </div>
            </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2">
            <div className="flex justify-between items-start">
              ...
              <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-foreground" onClick={() => window.location.href = '/dashboard/payments'}>
                <ChevronRight className="h-4 w-4" />
              </Button>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4">
              <Button variant="outline" size="sm" className="w-full" onClick={() => window.location.href = '/dashboard/payments'}>
                View All Invoices
              </Button>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <div className="flex justify-between items-start">
              ...
              <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-foreground" onClick={() => window.location.href = '/dashboard/announcements'}>
                <ChevronRight className="h-4 w-4" />
              </Button>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4">
              <Button variant="outline" size="sm" className="w-full" onClick={() => window.location.href = '/dashboard/announcements'}>
