...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-clinic-50 to-white dark:from-slate-900 dark:to-slate-800 py-28 md:py-36">
      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 lg:pr-16 mb-16 lg:mb-0">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8 max-w-lg animate-slide-up">
            Expert Women's Healthcare for Every Stage of Life
          </h1>
          <p className="text-lg text-muted-foreground mb-10 max-w-lg animate-slide-up" style={{animationDelay: '0.1s'}}>
          ...
          <div className="flex flex-wrap gap-5 animate-slide-up" style={{animationDelay: '0.2s'}}>
            <Button 
              size="lg" 
              className="bg-clinic-600 hover:bg-clinic-700 text-white shadow-md hover:shadow-lg transition-all"
              asChild
            >
        ...
        <div className="lg:w-1/2 animate-blur-in" style={{animationDelay: '0.3s'}}>
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-clinic-500 to-clinic-400 rounded-3xl blur-lg opacity-75"></div>
            <img 
